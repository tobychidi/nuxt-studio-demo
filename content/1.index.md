...
This is super cool and  i love it. A lot of the lag is gone. Still much more to improve. I will be back to learn even more. 

A heavy Nuxt theme to build a Markdown driven website, based on [Nuxt Content](https://content.nuxtjs.org), [TailwindCSS](https://tailwindcss.com) and [Iconify](https://iconify.design) :sparkles:
...
To customize fdfdfd the title displayed in the navigation, you can set the `navigation.title` property in the front-matter of your pages:
